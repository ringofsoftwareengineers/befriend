...
function exportToExcel() {
    ...
    $result = get_all_assigned_surveys();
    ...
    $objPHPExcel->getProperties()->setCreator("BefriendAChildUK")
            ...
            ->setCategory("Pending Survey List");
    ...
    header('Content-Disposition: attachment;filename="pending-surveys.xlsx"');
...
<div id="content-outer">
    ...
    <div id="content">
        ...
        <div id="page-heading"><h1>Pending surveys <a href="?download_list" class="btn btn-default" style="color: white; background-color: blue; float: right; width: 200px;">Download List</a></h1></div>
